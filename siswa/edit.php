        ...
        <div class="container-fluid">
            <div class="header row">
                <div class="col-lg-12">
                    ...
                    <h2 class="brand">EDIT DATA SISWA</h2>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    ...
                    <form action="proses.php" method="post">
                        <div class="form-group">
                            ...
                            <input type="number" name="nomor_induk" id="nomor_induk" value="<?= $data['nomor_induk'] ?>" class="form-control" required autofocus>
                        </div>
                        <div class="form-group">
                            <label for="nama_siswa">Nama Siswa</label>
                            <input type="text" name="nama_siswa" id="nama_siswa" value="<?= $data['nama_siswa'] ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ruangan" id="ruangan" value="<?= $data['ruangan'] ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
