        ...
        <div class="container-fluid">
            <div class="header row">
                <div class="col-lg-12">
                    ...
                    <h2 class="brand">EDIT DATA GURU</h2>
            ...
            <div class="content row">
                <div class="col-lg-6 col-lg-offset-3">
                    <?php
                    $id = @$_GET['id'];
                    $sql_guru = mysqli_query($con, "SELECT * FROM tb_guru WHERE id_guru = '$id'") or die(mysqli_error($con));
                    $data = mysqli_fetch_array($sql_guru);
                    ?>
                    <form action="proses.php" method="post">
                        <div class="form-group">
                            <label for="nomorinduk_guru">Nomor Induk</label>
                            <input type="hidden" name="id" value="<?= $data['id_guru'] ?>">
                            <input type="number" name="nomorinduk_guru" id="nomorinduk_guru" value="<?= $data['nomorinduk_guru'] ?>" class="form-control" required autofocus>
                        </div>
                        <div class="form-group">
                            <label for="nama_guru">Nama Guru</label>
                            <input type="text" name="nama_guru" id="nama_guru" value="<?= $data['nama_guru'] ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="wali_kelas" id="wali_kelas" value="<?= $data['wali_kelas'] ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
