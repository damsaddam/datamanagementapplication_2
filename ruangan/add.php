            ...
            <div class="header row">
                <div class="col-lg-12">
                    ...
                    <div class="pull-right">
                        <a href="data.php" class="btn refresh"><i class="bi bi-house-fill"></i>Lihat Data Ruangan</a>
                        <a href="generate.php" class="btn refresh"><i class="bi bi-house-add-fill"></i>Tambah Ruangan Lagi</a>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    ...
                                    for ($i = 1; $i <= $_POST['count_add']; $i++) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="lantai-<?= $i ?>" class="form-control" required>
                                            </td>
                                        </tr>
                                    <?php
                                    }
